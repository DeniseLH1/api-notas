import {CrearNotaDTO} from '../dtos/actualizar-nota.dto.js';
import { ActualizarNotaODT } from '../dtos/actualizar-nota.dto.js';
...
export async function actualizarNota(req,res,next) {
    try{
        const datos = new ActualizarNotaODT(req.body);
